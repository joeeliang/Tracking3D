...
while running:
    ...
    orientation1 = 45
    orientation2 = 135
    camera_angle1 = (angle1 - orientation1 - FOV/2)
    if 0 <= -camera_angle1 <= 60:
        print(f"camera 1 pixels: {int(-camera_angle1 * 1000 / FOV)}")
        print(-camera_angle1)
    else:
        print("out of view of camera 1!")
    angle2 = calculate_angle(camera2_pos, mouse_pos)
    camera_angle2 = (-angle2 - (orientation2-FOV/2))
    print(camera_angle2)
    if 0 <= camera_angle2 <= 60:
        print(f"camera 2 pixels: {int(camera_angle2 * 1000 / FOV)}")
        print(-180-angle2)
    else:
        print("out of view of camera 2!")
