...
while True:
    ...
    # Process frames
    processed_frame1, mask1, a1 = process_frame(frame1)
    processed_frame2, mask2, a2 = process_frame(frame2)

    if a1 is not None and a2 is not None:
        update_plot(cameraTrack.triangulate(a1, a2))
        plt.show()
